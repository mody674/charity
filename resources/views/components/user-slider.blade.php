...
<a class="sidebar-item" href="{{url('home')}}">
<span class="material-symbols-outlined">dashboard</span>
<span class="font-bold">الرئيسية</span>
</a>

<a class="sidebar-item" href="{{url('donate')}}">
<span class="material-symbols-outlined">favorite</span>
<span class="font-bold"> تبرع الآن</span>
</a>
<a class="sidebar-item active" href="{{url('dontes')}}">
<span class="material-symbols-outlined">favorite</span>
<span class="font-bold">تبرعاتي</span>
</a>
<a class="sidebar-item" href="{{url('stories')}}">
