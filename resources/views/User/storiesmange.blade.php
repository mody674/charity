...
<a class="sidebar-item" href="admindashboard.html">
<span class="material-symbols-outlined">dashboard</span>
<span class="font-bold">الإحصائيات العامة</span>
</a>
<a class="sidebar-item" href="donatesmanage.html">
<span class="material-symbols-outlined">favorite</span>
<span class="font-bold">التبرعات</span>
</a>
<a class="sidebar-item" href="usermanage.html">
...
<a class="sidebar-item" href="projectmanagement.html">
<span class="material-symbols-outlined">assignment</span>
<span class="font-bold">المشاريع النشطة</span>
</a>
<a class="sidebar-item active" href="storiesmange.html">
<span class="material-symbols-outlined">auto_awesome</span>
<span class="font-bold">قصص الأثر</span>
</a>
<a class="sidebar-item" href="systemsettings.html">
...
<h2 class="text-2xl font-black text-slate-800">إدارة قصص الأثر</h2>
<p class="text-sm text-slate-500">توثيق النجاح وعرض قصص المستفيدين</p>
</div>
<div class="flex items-center gap-6">
<button id="addStoryBtn" class="bg-primary hover:bg-primary-dark text-white font-bold px-6 py-2.5 rounded-lg flex items-center gap-2 transition-all shadow-sm">
<span class="material-symbols-outlined text-xl">add_circle</span>
                    إضافة قصة جديدة
                </button>
<div class="flex items-center gap-4 border-r pr-6 border-slate-100">
<button class="p-2 text-slate-400 hover:text-primary transition-colors relative">
<a href="notifications.html"><span class="material-symbols-outlined">notifications</span></a>
<span class="absolute top-2 right-2 w-2 h-2 bg-red-500 rounded-full"></span>
</button>
<div class="flex items-center gap-3 border-r pr-4 border-slate-100">
<div class="text-left hidden md:block">
<p class="text-sm font-bold text-slate-800 leading-none">أحمد محمد</p>
<p class="text-xs text-slate-500 mt-1">مدير النظام</p>
</div>
