...
<body class="bg-background-main text-slate-900 min-h-screen flex">
    ...
    <script>
        document.getElementById('downloadGuide').addEventListener('click', () => {
            ...
            doc.text("دليل المستندات المطلوبة لطلب المساعدة", 105, 30, {
                align: "center"
            });

            doc.setFontSize(14);
            doc.setTextColor(75, 85, 99);
            doc.text("مؤسسة معًا نصنع الأمل - إصدار مارس 2026", 105, 45, {
                align: "center"
            });
            ...
            doc.text("مؤسسة معًا نصنع الأمل - جميع الحقوق محفوظة © 2026", 105, 280, {
                align: "center"
            });
            doc.text("جمهورية مصر العربية", 105, 287, {
                align: "center"
            });
